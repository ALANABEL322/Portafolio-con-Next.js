    ...
    <div>
      <div className="  w-screen min-h-screen">
        ...
        <div className=" flex justify-center items-center">
          <Image
            src={
              "https://res.cloudinary.com/dn5ltihzv/image/upload/v1709677824/imagenes/cardContact.svg"
            }
            width={800}
            height={500}
        ...
        {/* <div className="flex right-0  items-center justify-center mb-10">
          <div className=" w-1/2 mr-20 items-center h-full justify-center profile-card  rounded-md shadow-xl overflow-hidden z-[100] relative cursor-pointer snap-start shrink-0 bg-white flex flex-col gap-3 transition-all duration-300 group">
            <div className="w-5/6 pt-5 flex items-center justify-center flex-col gap-1">
            ...
            <div className="px-4 w-full items-center justify-center flex">
