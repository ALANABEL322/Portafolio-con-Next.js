...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`w-2/2 flex  flex-col items-center justify-center text-gray-300  ${
      ...
      <div
        className={`${styles.sectionAbout} w-screen md:h-screen md:max-h-screen max-w-full flex flex-col items-center bg-gradient-to-b from-transparent to-gray-900 `}
      >
        ...
        <div className="container w-1/2 h-[32rem] flex flex-col justify-center items-center mt-4">
          ...
          ></div>
          <p className=" md:hidden lg:hidden xl:hidden md:w-5/6  text-gray-300 font-semibold mt-2 md:text-5xl">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum in
            aspernatur iure fuga voluptas repellat asperiores voluptatum
          </p>
        </div>
        ...
        <div className="container w-1/2 h-[32rem]  flex flex-col justify-center items-center mt-4">
          ...
          ></div>
          <div className=" ">
            <p className="text-wrap md:hidden lg:hidden xl:hidden md:w-5/6  text-gray-300 font-semibold mt-2 md:text-5xl">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum in
              aspernatur iure fuga voluptas repellat asperiores voluptatum
            </p>
          </div>
        ...
        <div className="container w-full  flex items-center justify-end  z-50">
          <Image
            src={
              "https://res.cloudinary.com/dn5ltihzv/image/upload/v1708794080/imagenes/Coffesvg.svg"
            }
            width={200}
            height={300}
            alt="image-violin"
      ...
      {/**section aboutme */}
      <div className="w-screen  lg:min-h-screen xl:min-h-screen max-w-full flex flex-col items-center bg-gradient-to-b from-transparent to-gray-900 lg:overflow-hidden">
        <h1 className="text-center text-gray-300 mt-11 m-[50px] font-bold xs:text-5xl sm:text-6xl md:text-7xl lg:text-7xl xl:text-7xl">
          about me{" "}
        </h1>

        <div className="md:flex justify-center items-center w-full">
          {/* Imagen en el extremo derecho en pantallas grandes */}
          <div className="hidden lg:w-3/5 md:block lg:block xl:block p-6 lg:p-0 xl:p-0">
            <p className="text-gray-300 lg:w-5/6 pl-7 flex justify-center items-center lg:block xl:block font-semibold lg:text-4xl xl:text-4xl ">
